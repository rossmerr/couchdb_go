...
func (o *ResultsDocs) UnmarshalJSON(bytes []byte) (err error) {
	varResultsDocs := _ResultsDocs{}

	if err = json.Unmarshal(bytes, &varResultsDocs); err == nil {
		*o = ResultsDocs(varResultsDocs)
	}
