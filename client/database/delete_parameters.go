...
// WithDb adds the db to the delete params
func (o *DeleteParams) WithDb(db string) *DeleteParams {
	o.SetDb(db)
	return o
}

// SetDb adds the db to the delete params
func (o *DeleteParams) SetDb(db string) {
	o.Db = db
}
