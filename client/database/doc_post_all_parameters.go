...
/* DocPostAllParams contains all the parameters to send to the API endpoint
   for the doc post all operation.
...
// WithDefaults hydrates default values in the doc post all params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DocPostAllParams) WithDefaults() *DocPostAllParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the doc post all params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DocPostAllParams) SetDefaults() {
...
// bindParamDocPostAll binds the parameter keys
func (o *DocPostAllParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
