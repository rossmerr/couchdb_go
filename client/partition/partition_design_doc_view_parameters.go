...
/* PartitionDesignDocViewParams contains all the parameters to send to the API endpoint
   for the partition design doc view operation.
...
// WithDefaults hydrates default values in the partition design doc view params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PartitionDesignDocViewParams) WithDefaults() *PartitionDesignDocViewParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the partition design doc view params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PartitionDesignDocViewParams) SetDefaults() {
