...
/* DesignDocViewPostParams contains all the parameters to send to the API endpoint
   for the design doc view post operation.
...
// WithDefaults hydrates default values in the design doc view post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DesignDocViewPostParams) WithDefaults() *DesignDocViewPostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the design doc view post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DesignDocViewPostParams) SetDefaults() {
...
// bindParamDesignDocViewPost binds the parameter keys
func (o *DesignDocViewPostParams) bindParamKeys(formats strfmt.Registry) []string {
	keysIR := o.Keys
