...
// ContextValidate validates this design doc based on context it is used
func (m *DesignDoc) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
