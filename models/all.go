...
// ContextValidate validate this all based on the context it is used
func (m *All) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *All) contextValidateDocs(ctx context.Context, formats strfmt.Registry) error {
